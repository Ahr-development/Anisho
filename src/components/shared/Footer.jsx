    ...
    return (
        <>
                ...
                <div className="mx-auto max-w-7xl px-6 py-24 sm:py-20 lg:flex lg:items-center lg:justify-between lg:px-8">
                    ...
                    <div className="mt-10 flex items-center gap-x-6 lg:mt-0 lg:flex-shrink-0">
                        <img
                            ...
                            alt="First Image"
                            className="w-48 object-cover rounded-lg shadow-lg"
                        />
                        <img
                            src="https://dmngo.ir/wp-content/uploads/2022/01/enamad-1.png"
                            alt="Second Image"
            ...
            <div className="fixed bottom-0 gap-5 left-0 w-full bg-gray-900 shadow-md border-t border-gray-300 flex justify-around items-center py-2 invisible max-w-640:visible z-10">
                ...
                <button className="flex flex-col items-center text-white hover:text-blue-500">
                    ...
                    >
                        ...
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M6 19.5a6.75 6.75 0 0 1 12 0"
                        />
                    </svg>
                ...
                <button className="flex flex-col items-center text-white hover:text-blue-500">
                    ...
                    >
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M3 10.5L12 3l9 7.5v8.25A2.25 2.25 0 0 1 18.75 21h-13.5A2.25 2.25 0 0 1 3 18.75V10.5z"
                        />
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                ...
                <button className="flex flex-col items-center text-white hover:text-blue-500" onClick={() => handleOpenCart()}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    >
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M6.75 3.75h12l-1.5 9H8.25L6.75 3.75z"
                        />
