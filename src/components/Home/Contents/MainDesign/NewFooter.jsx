...
const NewFooter = () => {
    return (<>
        ...
        <div className=" max-w-672:mb-5 ml-32 mr-32 max-w-967:mr-3 max-w-967:ml-3 bg-gray-200 grid grid-cols-2 max-w-672:grid-cols-1 h-40 max-w-672:h-auto rounded-3xl -mt-40 max-w-1010:mt-0 z-10">
            {/* بخش input */}
            <div className="flex justify-items-center items-center ml-16 max-w-672:order-2 max-w-672:ml-0 max-w-672:justify-center max-w-672:mt-4">
                <div className="relative rounded-full overflow-hidden bg-white shadow-xl w-[450px] max-w-761:w-[250px]">
                    <input
            ...
            {/* بخش متن */}
            <div className="justify-items-end items-end max-w-672:order-1 max-w-672:text-center max-w-672:flex max-w-672:flex-col max-w-672:items-center">
                <h3 className="text-4xl kalamehExtraBold mt-8 mr-16 max-w-761:mr-5 max-w-1255:text-2xl max-w-672:mr-0">
                    لحظــــه به لحظه داستان با آنیشو
                </h3>
                <h3 className="text-xl max-w-1255:text-sm mt-2 mr-16 max-w-761:mr-5 max-w-672:mr-0 text-right max-w-672:text-center">
                    کافیست ایمیل خودتان را وارد کنید تا با هر خبری که ارسال میکنیم برای شما یک تخفیف رندوم بفرستیم
                </h3>
            </div>
        </div>
        ...
        <div className="justify-items-center items-center bg-gray-200 h-60 max-w-767:h-full -mt-16">
            ...
            <ul class="text-xl flex items-center -mt-10  justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 ">
                ...
                <li><a href="#" class=" text-gray-800 hover:text-gray-900">تماس با ما</a></li>
                <li><a href="#" class=" text-gray-800 hover:text-gray-900">آنیشو بلاگ</a></li>
